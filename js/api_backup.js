                    ...
                    if (refreshToken) {
                        ...
                        try {
                            ...
                            if (newTokens && newTokens.token) {
                                ...
                                // Update storage
                                const storageKey = sessionStorage.getItem('js_user') ? 'sessionStorage' : 'localStorage';
                                window[storageKey].setItem('js_user', JSON.stringify(user));
                                
                                // Update default headers for retry
                                defaultHeaders.Authorization = `Bearer ${newTokens.token}`;
